...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                 AIDIL DEV OFFCIAL               [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "aidilriskii" ]; then
    ...
    echo -e "${GREEN}Token Salah! Beli Kode Token Di AidilDev${NC}"
...
doneOPEN :
ADMIN PANEL 15K SEBULAN 
PT PANEL 20K SEBULAN
OWNER 30K SEBULAN 
VPS GUD QUALITY ✅
SPEK 16 CORE 4
MINAT PM 
wa.me/6281396484112#!/bin/bash
